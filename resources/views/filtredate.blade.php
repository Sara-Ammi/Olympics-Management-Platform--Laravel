...
@section('content')
<div class="container">
    <h1 class="text-center mb-4">Compétitions pour le {{ $date }}</h1>
                ...
                @foreach ($competitions as $competition)
                    <li class="list-group-item">
                        <div>
                            ...
                            <p class="mb-0"><strong>Lieu:</strong> {{ $competition->lieu->nom }}</p>
                            <p class="mb-0"><strong>Heure de début:</strong> {{ $competition->heure_debut }}</p>
                            <p class="mb-0"><strong>Heure de fin:</strong> {{ $competition->heure_fin }}</p>
                        </div>
                    </li>
                @endforeach
            </ul>
