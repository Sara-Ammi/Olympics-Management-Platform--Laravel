...
<div class="d-flex justify-content-center vh-100">
    <div class="text-center">
        ...
        <h1 class="mt-3">Connexion requise pour accéder à cette page 
            veuillez vous inscrire en cliquant sur le boutton ( s'inscrire ) dans le menu
        </h1>
    </div>
</div>
@endauth
